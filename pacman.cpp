...
void Pacman::setPacman(Pacman* pacman)
{
	this->pacman = pacman;
}
...
void Pacman::draw()
{
	...
	glVertex2f((x - maxX) / 25, (y - 14)/25);

	if (angle > 0.4)  //pacman mouth angle
		angle = 0.0;
	angle += 0.1;

	if (direction == 0) {            //left
		glVertex2f((x - maxX) / 25 - 0.7, ((y - 14) / 25 + angle));
		glVertex2f((x - maxX) / 25 - 0.7, ((y - 14) / 25 - angle));
	}
	else if (direction == 2 || direction == -1) {       //right
		glVertex2f((x - maxX) / 25 + 0.7, ((y - 14) / 25 + angle));
		glVertex2f((x - maxX) / 25 + 0.7, ((y - 14) / 25 - angle));
	}
	else if (direction == 1) {       //down
		glVertex2f((x - maxX) / 25 + angle, ((y - 14) / 25 + 0.7));
		glVertex2f((x - maxX) / 25 - angle, ((y - 14) / 25 + 0.7));
	}
